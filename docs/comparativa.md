...
| Cliente del LLM | **Cliente directo de Ollama** | LangChain, LlamaIndex | Tres herramientas: sin capas intermedias es más fácil de auditar qué llama el modelo |
...
Grafana 11.5.1 · Ollama 0.34.1 · Python 3.12 · FastAPI 0.141 · Chainlit 2.12.
